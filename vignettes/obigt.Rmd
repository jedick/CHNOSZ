...
cat('These species, taken mainly from slop98.dat, were present in earlier versions of CHNOSZ but have been replaced by or are incompatible with other updates for aqueous Al species [@TS01], As species [@MA07; @MA10], Au, Ag, and Cu species [@AZ01; @AZ10], Pd species [@TBZ+13], and Pt species [@TBB15]. The data are kept here to enable comparisons with newer data and reproduction of published calculations. Use <span style="color:red">`add.obigt("SLOP98")`</span> to load the data.\n\n')
```
