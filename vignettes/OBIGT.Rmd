...
These species, whose parameters were listed in slop98.dat (or later versions) and were present in earlier versions of CHNOSZ,
have been replaced by or are incompatible with species currently in the default database.
...
<div id="D-optional-SLOP98b" style="display: none">
## <a id="optional-SLOP98b" class="anchor"></a> `r setfile("SLOP98b.csv")`
These are data from several studies that were part of or depend on slop98.dat.
Included here are estimated thermodynamic parameters for REE complexes and metal-organic complexes.

For some elements, the data here are superseded by newer studies (see description in the **SLOP98** tab).
For better maintainability and findability, the data from each study are stored in this
optional data file rather than being separated into default and optional data files.

Use `add.OBIGT("SLOP98b")` to load the data.
...
Updates for Cu complexes from researchers at the Institute of Geology of Ore Deposits, Petrography, Mineralogy, and Geochemistry, Russian Academy of Sciences (IGEM RAS) [@AZ23;@TTA+23].
