...
Except for HUO<sub>4</sub><sup>-</sup>, aqueous uranium species from @SSB97 have been moved here to avoid possible inconsistencies with data for uranyl complexes from @MBA+24.
Furthermore, transuranic actinide complexes are listed here as no entropies of the corresponding elements at 298.15 K are available to check the self-consistency of the GHS values for the complexes.
