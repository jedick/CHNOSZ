...
Except for HUO<sub>4</sub><sup>-</sup>, aqueous uranium species from @SSB97 have been moved here to avoid possible inconsistencies with uranyl complexes from @MBA+24.
...
Model for the Mg(OH)<sub>2</sub>-MgCl<sub>2</sub>-H<sub>2</sub>O system from 25 to 150 &deg;C.
